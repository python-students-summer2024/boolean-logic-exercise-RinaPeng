...
def is_sweltering():
    ...
    # Check if the temperature is above 90 degrees Fahrenheit
    if temperature > 90:
        return True
    else:
        return False
...
def is_inclement():
    ...
    """
    # write your code for this function below this line.
    weather = input("What is the weather forecast for today?: ").lower()
    return "rain" in weather or "snow" in weather or "sleet" in weather
